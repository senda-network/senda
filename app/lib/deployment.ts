 ...
 *
 * - `proxy.ts` (edge): `NEXT_PUBLIC_DEPLOYMENT`, `SENDA_DEPLOYMENT`.
 ...
 *   PLUS `NEXT_PUBLIC_SENDA_DEPLOYMENT` — and notably ignored by
 *   the other two.
 *
 * That skew let a misconfigured Vercel project set, say, only
 * `NEXT_PUBLIC_SENDA_DEPLOYMENT=public` and end up with a public
